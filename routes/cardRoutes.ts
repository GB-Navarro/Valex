...
cardRouter.get("/viewCardBalance", cardMiddlewares.validateCardBalanceSchema ,cardController.viewCardBalance);
...
cardRouter.post("/rechargeCard", cardMiddlewares.validateRechargeCardSchema ,cardController.rechargeCard);
